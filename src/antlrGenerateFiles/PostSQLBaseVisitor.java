...
public class PostSQLBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements PostSQLVisitor<T> {
	 ...
	 */
	@Override public T visitSqlScript(PostSQLParser.SqlScriptContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitUseDatabase(PostSQLParser.UseDatabaseContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
