...
public class FilePathTreeItem extends TreeItem<String> {
    ...
    public static Image folderExpandImage=new Image(ClassLoader.getSystemResourceAsStream("open_folder.png"));
    public static Image fileImage=new Image(ClassLoader.getSystemResourceAsStream("text.png"));
